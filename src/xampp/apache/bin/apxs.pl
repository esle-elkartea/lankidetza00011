...
my $CP    = 'C:C:\xampp\perl\bin\perl.EXE -MExtUtils::Command -e cp';
my $CHMOD = 'C:C:\xampp\perl\bin\perl.EXE -MExtUtils::Command -e chmod';
my $RM_F  = 'C:C:\xampp\perl\bin\perl.EXE -MExtUtils::Command -e rm_f';
my $TOUCH = 'C:C:\xampp\perl\bin\perl.EXE -MExtUtils::Command -e touch';
